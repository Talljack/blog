...
export const templates: Template[] = [
  {
    ...
    description: '基于 Next.js 15 的现代博客模板，包含深色主题、搜索功能、标签系统、SEO优化等功能。适用于个人博客、技术博客等场景。',
  ...
  },
  {
    ...
    description: '响应式落地页模板，适用于产品展示、SaaS应用等场景，包含多种组件和布局选项。支持多种动画效果和现代化设计。',
  ...
  },
  {
    id: 3,
    title: 'Dashboard 模板',
    description: '现代化管理后台模板，包含图表、表格、表单等常用组件，支持多主题切换。适用于后台管理系统、数据可视化等场景。',
...
export function getFeaturedTemplates(): Template[] {
  return templates.filter(template => parseInt(template.stars.replace('k', '')) >= 2)
}